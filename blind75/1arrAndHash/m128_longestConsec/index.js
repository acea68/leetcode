...
//     if (prev in map) { // if prev & next in map
//       if (next in map) {
...
//         ++map[prev - map[prev] + 1];
//       }
//     } else if (next in map) { // in only next in map
//       len += map[next];
//       ++map[next + map[next] - 1];
//     }
//     map[num] = len;
...
//     if (set.has(num - 1)) { // check previous num => num not start of count
//       continue;
//     }
//     // found lowest start of acount
//     let currentMax = 1;
